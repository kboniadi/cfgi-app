    ...
    <ScrollView>
      ...
      <View style={styles.jobContainer}>
        <View style={{ padding: hp("3%"), flex: 1 }}>
          ...
          >
            Please sign up below, we will contact you soon.
          </Text>
          ...
          <View style={{ paddingVertical: hp("1.5%") }}>
            <TextInput //placeholder="Email Address"
              ...
              style={styles.jobInput}
              onEndEditing={(name) =>
                onlyRegex(name.nativeEvent.text, "^.+@.+\\..+$", setEmailError)
              }
            />
          </View>
          ...
          <View style={{ paddingVertical: hp("1.5%") }}>
            <TextInput
              style={styles.jobInput} //placeholder="Phone Number (optional)"
              onChangeText={(name) => setPhone(name)}
              onEndEditing={(name) =>
                optional_phone(name.nativeEvent.text, "^(\\+)?[0-9]{9,18}$", setPhoneError)
              }
            />
          </View>
          ...
          <View style={{ paddingVertical: hp("1.5%") }}>
            <TextInput
              style={styles.jobInput} //placeholder="Company Name"
  ...
  return (
    ...
    <View style={{ paddingTop: "5%", paddingHorizontal: "5%", backgroundColor: "#F7F5F9" }}>
      <View style={{ paddingTop: "5%" }}>
        <Image
          style={{ marginBottom: hp("3%"), marginLeft: wp("15%") }}
          source={require("../assets/img/arrow-left.png")}
        />
        <Image
          style={{ marginLeft: -wp("15%"), marginRight: wp("5%") }}
          source={require("../assets/img/arrow-right.png")}
        />
      </View>
      <View style={{ flexDirection: "row", paddingTop: "5%", paddingHorizontal: "5%" }}>
        <View style={{ flexDirection: "column" }}>
          <Text style={{ fontSize: 24, color: "#FF6E00", fontWeight: "bold" }}>
            Inspired to Give
          </Text>
          <Text style={{ fontSize: 54, color: "#3F3356", fontWeight: "bold" }}>
            Donate{"\n"}Now
          </Text>
        </View>
        <Image
          style={{ width: hp("20%"), height: hp("20%"), marginLeft: wp("2%") }}
          source={require("../assets/img/donation-box.png")}
        />
      </View>
      ...
      <View style={{ paddingHorizontal: "5%" }}>
        <View style={{ paddingRight: "25%", paddingTop: "1%" }}>
          <Text style={{ fontSize: 18, color: "#3F3356" }}>
            With your donation,{"\n"}we can continue to support international students with
            financial assistance, legal help, job opportunities, so they can stay and thrive in the
            United States.
          </Text>
        </View>
      </View>
      <View style={{ paddingTop: "5%", paddingHorizontal: "25%" }}>
        ...
        <Pressable
          style={styles.button}
          onPress={() => {
            Linking.openURL("https://www.paypal.com/donate?hosted_button_id=SXQDLBKH55C42");
          }}
        >
      ...
      <View style={{ alignItems: "center" }}>
        <View style={{ flexDirection: "row", paddingTop: "5%" }}>
          <Text style={{ fontSize: 12, color: "#FF6E00", opacity: 0.8 }}>
            Help international students{"\n"}reach for the American dream
          </Text>
          <Image
            style={{ width: hp("3%"), height: hp("4%"), marginLeft: hp("2%") }}
