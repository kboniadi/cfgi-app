    ...
    <ScrollView>
        <View style={styles.container}>
            ...
            <DropDownPicker
                ...
                onChangeValue = {degree => { setDegreeValue(degree); setDegreeError(false)}}
            ...
            <DropDownPicker
                ...
                onChangeValue = {marital => {setMaritalValue(marital); setMaritalError(false)}}
                // There's no search bar
                searchable = {false}
                // Making it scrollable
                listMode = "SCROLLVIEW"
            ...
            <DropDownPicker
                ...
                onChangeValue = {status => {setStatusValue(status); setStatusError(false)}}
                // There's no search bar
                searchable = {false}
                // Making it scrollable
                listMode = "SCROLLVIEW"
