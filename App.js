...
export default function App() {
  ...
  function LegalStack() {
    return (
      ...
      >
        <Stack.Screen name="AppointDocs" component={AppointmentScreen} />
        <Stack.Screen name="calendar" component={CalendlyScreen} />
      </Stack.Navigator>
    );
  }
  ...
  function FinStack() {
    return (
      ...
      >
        {/* Landing page */}
        <Stack.Screen name="Financial" component={FinScreen} />
        <Stack.Screen name="termsAndConditions" component={termsAndConditions} />
        {/* Actual application */}
        <Stack.Screen name="FinDocs" component={FinAppScreen} />

        <Stack.Screen name="FinAppConfirmation" component={FinAppConfirmationScreen} />
      </Stack.Navigator>
    );
  }
        ...
        {userToken ? (
          <Tab.Navigator
            ...
            tabBarOptions={{
              ...
              activeTintColor: "#3C65CC",
              inactiveTintColor: "#3E3D3D",
            }}
          >
            <Tab.Screen
